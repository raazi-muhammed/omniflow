...
function buildVerifyUserMiddleware({ token, }) {
    return (expressReq, res, next) => __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!tokenData)
                throw new error_handler_1.NotFoundError("Token not found");
            token.validate(tokenData);
            const decodedTokenData = yield token.verify(tokenData);
            if (!decodedTokenData)
                new Error("Invalid token data");
            // @ts-ignore
...
exports.default = buildVerifyUserMiddleware;
